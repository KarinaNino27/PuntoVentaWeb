...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand " href="ventanaEmpleados.php">Empleados</a>
    ...
    <div id="divContenedorTabla" class="container">
        ...
        <div>
            <a href="registroEmpleado.php" class="btn btn-success">Agregar</a>
            <p></p>
        </div>
        <table id="tblRegistros" class="table table-bordered table table-striped table-hover">
            ...
            <tbody>
                <?php
                    foreach ($listaEmpleados as $objEmpleado){
                    echo"<tr><td>".$objEmpleado->idEmpleado."</td>".
                            "<td>".$objEmpleado->user."</td>".
                            "<td>".$objEmpleado->nombre."</td>".
                            "<td>".$objEmpleado->apellido."</td>".
                            "<td>".$objEmpleado->correo."</td>".
                            "<td>".$objEmpleado->telefono."</td>".
                            "<td>".$objEmpleado->direccion."</td>".
                            "<td>".$objEmpleado->rol."</td>"."
                            <td>
                                
                                <form method='POST'>
                                    <button formaction='registroEmpleado.php' name='idEmpleado' value='$objEmpleado->idEmpleado' class='btn btn-warning'>Editar</button>
                                    <button formaction='eliminarEmpleado.php' name='idEmpleado' value='$objEmpleado->idEmpleado' class='btn btn-danger'>Eliminar</button>
                                </form>
